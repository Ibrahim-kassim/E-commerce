...
const Hero = () => {
  ...
  return (
    ...
    data-aos='fade-up' data-aos-offset='200' data-aos-delay='50' data-aos-duration='1000' data-aos-easing='ease-in-out'
     className='sm:flex items-center sm:h-[100vh]  h-full justify-center lg:px-12 pt-8 Hero'>
        <div className='h-full w-full flex flex-col sm:items-start items-center flex-1 justify-center pb-40 px-16 leading-10 '>
            ...
            className='flex rounded-full gap-4 bg-red-600 mt-12 px-8 py-2 items-center text-white'>
