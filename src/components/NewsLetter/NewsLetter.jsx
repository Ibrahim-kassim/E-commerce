...
const NewsLetter = () => {
  return (
    <div
    data-aos='fade-down' data-aos-offset='200' data-aos-delay='50' data-aos-duration='1000' data-aos-easing='ease-in-out'
    
    className="w-full max-w-4xl mx-auto my-24 px-4 lg:px-0 graidant  h-[60vh] flex items-center justify-center flex-col"> {/* Added Tailwind classes for responsiveness */}
