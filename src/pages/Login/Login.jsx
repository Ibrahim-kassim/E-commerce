...
const Login = () => {
  return (
    <div className='bb'>
      <div className='flex flex-col items-center  justify-center h-[80vh] gradiaant  '>
        <div className='h-[70vh] bg-white box-border shadow-2xl items-start justify-between px-8 py-8 flex flex-col w-[60vh]'>
          ...
          <div className='flex items-center gap-4 mt-4'>
            <input type="checkbox" className='cursor-pointer  h-full' name="" id="" />
            <p className='leading-6 w-full'>By continuing , i agree the terms of use & privacy policy.</p>
          </div>
        </div>
        </div>
      </div>
